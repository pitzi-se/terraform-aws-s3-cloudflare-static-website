...
variable "subdomains" {
  type        = list(string)
  default     = null
  description = "A list of subdomains to point to the same S3 website."
}
variable "bucket_owners" {
  type        = list(string)
  description = "The ARNs of the principals that should be bucket owners."
}
